...
var SearchBar = (props) => (
  ...
  <form onSubmit={(event) => event.preventDefault()} className="example" action="">
    {/* Everything there's a change 'onChange' method will re-render the data. Even if backspace then it will render for the new result */}
